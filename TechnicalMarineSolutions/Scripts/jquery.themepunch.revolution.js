...
(function(e, t) {
		...
		if (!r.hasClass("revslider-initialised")) {
			...
			r.find(".tp-caption").each(function(n) {
				try {
					if ((e(this).data("ytid") != t || e(this).find("iframe").attr("src").toLowerCase().indexOf("youtube") > 0) && x == 0) {
						...
						var o = true;
						e("head").find("*").each(function() { if (e(this).attr("src") == i + "://www.youtube.com/iframe_api")o = false });
						if (o) {
				...
				try {
					if ((e(this).data("vimeoid") != t || e(this).find("iframe").attr("src").toLowerCase().indexOf("vimeo") > 0) && T == 0) {
						...
						var s = document.getElementsByTagName("script")[0];
						var o = true;
						e("head").find("*").each(function() { if (e(this).attr("src") == k + "://a.vimeocdn.com/js/froogaloop2.min.js")o = false });
			...
			e(window).on("mozfullscreenchange webkitfullscreenchange fullscreenchange", function() {
				...
				if (e("body").data("rs-fullScreenMode")) {
					setTimeout(function() { e(window).trigger("resize") }, 200);
				}
			});
	...
	e.fn.extend({
		...
		revmaxslide: function(t) { return e(this).find(" > ul:first-child > li").length },
	...
	var E = function(t, n, r) {
		r.find(".slot").each(function() { e(this).remove() });
		n.transition = 0;
	};
	var S = function(n, r) {
	...
	var L = function(n, r, i, s, o, u) {
		...
		if (f == 16) {
			...
			C.add(punchgs.TweenLite.fromTo(s.find(".tp-half-two"), N / 800, { width: B, height: F, overflow: "hidden", position: "absolute", top: F / 2, left: "0px", force3D: "auto", transformOrigin: "center bottom" }, {
				scale: ot,
				rotation: et,
				y: F + F / 4,
	...
	var A = function(e, t, n, r, i, s, o) {
		punchgs.TweenLite.to(n.find(".defaultimg"), .001, { autoAlpha: 1, onComplete: function() { E(e, t, i) } });
		if (i.index() != s.index()) {
			punchgs.TweenLite.to(s, .2, { autoAlpha: 0, onComplete: function() { E(e, t, s) } });
		}
		t.act = t.next;
			...
			if (g == 0) {
							...
							if (!n.hasClass("HasListener")) {
													...
													events: {
														...
														onReady: function(n) {
															...
															if (!J() && s.data("autoplay") == true || z) {
																s.data("timerplay", setTimeout(function() { n.target.playVideo() }, s.data("start")));
															}
								...
								if (!i) {
									...
									if (!J() && h.data("autoplay") == true || z) {
										h.data("timerplay", setTimeout(function() { u.playVideo() }, h.data("start")));
									}
								}
							}
							...
							if (!n.hasClass("HasListener")) {
								...
								var m = setInterval(function() {
									if ($f != t) {
										if (typeof $f(y).api != t && typeof $f(y).api != "undefined") {
											$f(u).addEvent("ready", function() { _(y, z) });
											clearInterval(m);
										}
									}
								}, 100);
								...
								if (!i) {
									if (!J() && (h.data("autoplay") == true || h.data("forcerewind") == "on")) {
										...
										h.data("timerplay", setTimeout(function() { if (h.data("autoplay") == true)b.api("play") }, h.data("start")));
									}
								}
							}
						}
				...
				if (h.find("img").length > 0) {
					...
					if (h.find("iframe").length > 0 || h.find("video").length > 0) {
						...
						h.find(".tp-resizeme, .tp-resizeme *").each(function() { q(e(this), r) });
						if (h.hasClass("tp-resizeme")) {
							h.find("*").each(function() { q(e(this), r) });
						}
						q(h, r);
						$ = h.outerHeight(true);
						V = h.outerWidth(true);
		...
		n.find(".rs-wave").each(function() {
			...
			if (n.data("timeline") == t) {
				...
				n.data("timeline").append(new punchgs.TweenLite.fromTo(a, o, { a: 360 }, {
					...
					onComplete: function() { n.data("timeline").restart() }
				}));
			}
		});
	};
			...
			if (s != 0) {
				...
				try {
					...
					if (p > d) {
						...
						e.each(v, function(e, t) { if (e != 0)t.pause() });
						if (o.css("opacity") != 0) {
	...
	var et = function(t, n) {
		...
		if (n.parallax == "scroll" || n.parallax == "scroll+mouse" || n.parallax == "mouse+scroll") {
			e(window).on("scroll", function(e) { tt(t, n) });
		}
	};
	var tt = function(t, n) {
		if (J() && n.parallaxDisableOnMobile == "on")return false;
	...
	var it = function(e, t, n) { punchgs.TweenLite.to(e.find(".tp-thumbcontainer"), .2, { force3D: "auto", left: t, ease: punchgs.Power3.easeOut, overwrite: "auto" }) };
})(jQuery);