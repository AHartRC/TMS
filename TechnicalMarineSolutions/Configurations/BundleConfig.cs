namespace TechnicalMarineSolutions.Configurations
{
	...
	public class BundleConfig
	{
		...
		public static void RegisterBundles(BundleCollection bundles)
		{
			...
			bundles.Add(
					    new ScriptBundle("~/bundles/jquerymixitup", UrlHelper.jqueryMixItUpJS).Include(
																									   $"~/Scripts/jquery.mixitup.*"));
			bundles.Add(
			...
			bundles.Add(
					    new ScriptBundle("~/bundles/jqueryvala", UrlHelper.jqueryValidateJS).Include(
			...
			bundles.Add(
					    new ScriptBundle("~/bundles/cldrUresolved", UrlHelper.cldrUnresolvedJS).Include(
			...
			bundles.Add(
					    new ScriptBundle("~/bundles/globalizeDate", UrlHelper.globalizeDateJS).Include(
																									   "~/Scripts/globalize/date.*"));
			bundles.Add(
					    new ScriptBundle("~/bundles/globalizeMessage", UrlHelper.globalizeMessageJS).Include(
																											 "~/Scripts/globalize/message.*"));
			bundles.Add(
					    new ScriptBundle("~/bundles/globalizeNumber", UrlHelper.globalizeNumberJS).Include(
																										   "~/Scripts/globalize/number.*"));
			bundles.Add(
					    new ScriptBundle("~/bundles/globalizePlural", UrlHelper.globalizePluralJS).Include(
																										   "~/Scripts/globalize/plural.*"));
			bundles.Add(
			...
			bundles.Add(new ScriptBundle("~/bundles/globalizeRuntimeRelativeTime",
										 UrlHelper.globalizeRuntimeRelativeTimeJS));
			...
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendar", UrlHelper.fullCalendarJS).Include(
																									 "~/Scripts/fullcalendar.*"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarGCAL", UrlHelper.fullCalendarGCALJS).Include(
																											 "~/Scripts/gcal.*"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangAll", UrlHelper.fullCalendarLangAllJS).Include(
																												   "~/Scripts/lang-all.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangAR", UrlHelper.fullCalendarLangARJS).Include(
																												 "~/Scripts/lang/ar.js"));
			bundles.Add(
			...
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangBG", UrlHelper.fullCalendarLangBGJS).Include(
																												 "~/Scripts/lang/bg.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangCA", UrlHelper.fullCalendarLangCAJS).Include(
																												 "~/Scripts/lang/ca.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangCS", UrlHelper.fullCalendarLangCSJS).Include(
																												 "~/Scripts/lang/cs.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangDA", UrlHelper.fullCalendarLangDAJS).Include(
																												 "~/Scripts/lang/da.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangDEAT", UrlHelper.fullCalendarLangDEATJS).Include(
																													 "~/Scripts/lang/de-at.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangDE", UrlHelper.fullCalendarLangDEJS).Include(
																												 "~/Scripts/lang/de.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangEL", UrlHelper.fullCalendarLangELJS).Include(
																												 "~/Scripts/lang/el.js"));
			bundles.Add(
			...
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangES", UrlHelper.fullCalendarLangESJS).Include(
																												 "~/Scripts/lang/es.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangFA", UrlHelper.fullCalendarLangFAJS).Include(
																												 "~/Scripts/lang/fa.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangFI", UrlHelper.fullCalendarLangFIJS).Include(
																												 "~/Scripts/lang/fi.js"));
			bundles.Add(
			...
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangFR", UrlHelper.fullCalendarLangFRJS).Include(
																												 "~/Scripts/lang/fr.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangHE", UrlHelper.fullCalendarLangHEJS).Include(
																												 "~/Scripts/lang/he.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangHI", UrlHelper.fullCalendarLangHIJS).Include(
																												 "~/Scripts/lang/hi.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangHR", UrlHelper.fullCalendarLangHRJS).Include(
																												 "~/Scripts/lang/hr.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangHU", UrlHelper.fullCalendarLangHUJS).Include(
																												 "~/Scripts/lang/hu.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangID", UrlHelper.fullCalendarLangIDJS).Include(
																												 "~/Scripts/lang/id.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangIS", UrlHelper.fullCalendarLangISJS).Include(
																												 "~/Scripts/lang/is.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangIT", UrlHelper.fullCalendarLangITJS).Include(
																												 "~/Scripts/lang/it.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangJA", UrlHelper.fullCalendarLangJAJS).Include(
																												 "~/Scripts/lang/ja.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangKO", UrlHelper.fullCalendarLangKOJS).Include(
																												 "~/Scripts/lang/ko.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangLT", UrlHelper.fullCalendarLangLTJS).Include(
																												 "~/Scripts/lang/lt.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangLV", UrlHelper.fullCalendarLangLVJS).Include(
																												 "~/Scripts/lang/lv.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangNB", UrlHelper.fullCalendarLangNBJS).Include(
																												 "~/Scripts/lang/nb.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangNL", UrlHelper.fullCalendarLangNLJS).Include(
																												 "~/Scripts/lang/nl.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangPL", UrlHelper.fullCalendarLangPLJS).Include(
																												 "~/Scripts/lang/pl.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangPTBR", UrlHelper.fullCalendarLangPTBRJS).Include(
																													 "~/Scripts/lang/pt-br.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangPT", UrlHelper.fullCalendarLangPTJS).Include(
																												 "~/Scripts/lang/pt.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangRO", UrlHelper.fullCalendarLangROJS).Include(
																												 "~/Scripts/lang/ro.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangRU", UrlHelper.fullCalendarLangRUJS).Include(
																												 "~/Scripts/lang/ru.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangSK", UrlHelper.fullCalendarLangSKJS).Include(
																												 "~/Scripts/lang/sk.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangSL", UrlHelper.fullCalendarLangSLJS).Include(
																												 "~/Scripts/lang/sl.js"));
			bundles.Add(
			...
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangSR", UrlHelper.fullCalendarLangSRJS).Include(
																												 "~/Scripts/lang/sr.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangSV", UrlHelper.fullCalendarLangSVJS).Include(
																												 "~/Scripts/lang/sv.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangTH", UrlHelper.fullCalendarLangTHJS).Include(
																												 "~/Scripts/lang/th.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangTR", UrlHelper.fullCalendarLangTRJS).Include(
																												 "~/Scripts/lang/tr.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangUK", UrlHelper.fullCalendarLangUKJS).Include(
																												 "~/Scripts/lang/uk.js"));
			bundles.Add(
					    new ScriptBundle("~/bundles/fullCalendarLangVI", UrlHelper.fullCalendarLangVIJS).Include(
																												 "~/Scripts/lang/vi.js"));
			bundles.Add(
			...
			bundles.Add(
					    new ScriptBundle("~/bundles/sammy", UrlHelper.sammyJS).Include(
																					   $"~/Scripts/sammy-{UrlHelper.sammyVersion}.*"));
			...
			bundles.Add(
					    new ScriptBundle("~/bundles/flexslider", UrlHelper.flexsliderJS).Include(
			...
			bundles.Add(new ScriptBundle("~/bundles/recaptcha", UrlHelper.googleRecaptchaJS));

			bundles.Add(new ScriptBundle("~/bundles/site").Include("~/Scripts/App/Variables.*",
																   "~/Scripts/App/Functions.*",
																   "~/Scripts/App/site.*"));
			...
			bundles.Add(
					    new StyleBundle("~/Content/jqueryuivader", UrlHelper.jqueryUIVaderCSS).Include(
																									   "~/Content/themes/vader/jquery.ui.*",
																									   new CssRewriteUrlTransform
																										   ()));
			...
			bundles.Add(new StyleBundle("~/Content/bootstrap", UrlHelper.bootstrapCSS).Include("~/Content/bootstrap.*",
																							   new CssRewriteUrlTransform
																								   ()));
			bundles.Add(
					    new StyleBundle("~/Content/bootstraptheme", UrlHelper.bootstrapThemeCSS).Include(
			...
			bundles.Add(
					    new StyleBundle("~/Content/fontawesome", UrlHelper.fontawesomeCSS).Include(
			...
			bundles.Add(new StyleBundle("~/Content/ionicons", UrlHelper.ioniconsCSS).Include("~/Content/ionicons.*",
																							 new CssRewriteUrlTransform()));
			bundles.Add(
					    new StyleBundle("~/Content/flexslider", UrlHelper.flexsliderCSS).Include(
																								 "~/Content/flexslider.*",
																								 new CssRewriteUrlTransform
																									 ()));
